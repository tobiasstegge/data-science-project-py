...
from ds_labs.ds_charts import dummify, plot_line, multiple_line_chart
...
def pattern_mining(data):
    ...
    savefig('images/pattern_mining/patterns.png')

    return patterns


def plot_top_rules(rules: DataFrame, metric: str, per_metric: str) -> None:
    _, ax = subplots(figsize=(15, 15))
    ax.grid(False)
    ax.set_axis_off()
    ...
    savefig('images/pattern_mining/top_rules.png')
